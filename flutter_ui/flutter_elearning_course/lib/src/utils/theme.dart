...
ThemeData myThemeData(BuildContext context) {
  return ThemeData(
    ...
    textTheme: GoogleFonts.latoTextTheme().copyWith(
      ...
      headline1: TextStyle(color: kFont, fontSize: 80),
      headline2: TextStyle(color: kFont, fontSize: 60),
      headline3: TextStyle(color: kFont, fontSize: 48),
      headline4: TextStyle(color: kFont, fontSize: 32),
      headline5: TextStyle(color: kFont, fontSize: 24, letterSpacing: 0),
      headline6: TextStyle(fontSize: 20, color: kFont, letterSpacing: 0.15),
      subtitle1: TextStyle(
        fontSize: 16,
        letterSpacing: 0.15,
        color: kFont,
